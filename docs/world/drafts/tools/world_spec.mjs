...
export const ISLANDS = [
  ...
  ['epave', "Île de l'Épave", 1930, 1400, 150, 62, 0.6],
...
export const LAKES = [
  ...
  { id: 'glace', name: 'Lac Glacé', x: -1450, z: -2150, rx: 120, rz: 90, level: 256, depth: 8 },
  { id: 'oasis_ambre', name: "Oasis d'Ambresable", x: -1300, z: 360, rx: 75, rz: 55, level: 37.5, depth: 4 },
  { id: 'oasis_mirages', name: 'Oasis des Mirages', x: -1760, z: 760, rx: 45, rz: 38, level: 0, depth: 3 },  // level 0 = auto (terrain - 2)
  { id: 'oasis_palmes', name: 'Puits des Palmes', x: -1000, z: 980, rx: 38, rz: 30, level: 0, depth: 3 },
  { id: 'vermeil', name: 'Lac Vermeil', x: -1020, z: -260, rx: 110, rz: 80, level: 0, depth: 6 },
  { id: 'miroir_aldmar', name: "Bassin des Rois", x: 120, z: -1080, rx: 50, rz: 35, level: 0, depth: 3 },
  { id: 'lave', name: 'Lac de lave du Brasier', x: 1450, z: -2050, rx: 55, rz: 55, level: 0, depth: 4, lava: true },
];
...
export const OUTPOSTS = [
  ...
  { id: 'poste_cendres', name: 'Poste des Cendres', x: 1010, z: -1620, r: 22, flat: 26 },
...
export const WAYPOINTS = [
  ...
  ['wp_delta', 'Delta de la Brumeuse', 1620, -300],
  ['wp_phare', 'Phare des Embruns', 1960, -1000],
  ['wp_cendres', 'Poste des Cendres', 1010, -1600],
...
export const DUNGEONS = [
  ...
  ['tombeau_sables', 'Tombeau des Sables', -1700, 1060, 'arène du Ver des sables au-dessus'],
  ['antre_sorciere', 'Antre de la Sorcière des marais', 1330, -760, 'hutte sur pilotis, boss swamp_hag'],
  ['grotte_marees', 'Grotte des Marées', 1950, 1330, "Île de l'Épave, accessible à marée… en barque"],
...
export const ROADS = [
  ...
  { id: 'sentier_glace', name: 'Sentier du Lac Glacé', cls: 'trail', grade: 0.22, pts: [[-1330, -1620], [-1370, -1760], [-1410, -1900], [-1400, -2000], [-1380, -2080]] },
  ...
  { id: 'route_cendres', name: 'Route des Cendres', cls: 'main', grade: 0.12, pts: [[640, -700], [800, -1150], [900, -1400], [1010, -1600]] },
  { id: 'sentier_brasier', name: 'Sentier du Brasier', cls: 'trail', grade: 0.3, pts: [[1010, -1600], [1150, -1560], [1260, -1650], [1200, -1780]] },
  { id: 'coulee', name: 'Sentier de la Coulée', cls: 'trail', grade: 0.35, pts: [[1200, -1780], [1330, -1700], [1520, -1700], [1700, -1760], [1640, -1860], [1560, -1940]] },
  { id: 'route_foret', name: 'Route de la Sylve', cls: 'main', grade: 0.12, maxCut: 30, maxFill: 26, pts: [[-60, -1120], [-20, -1300], [0, -1470], [-40, -1620], [-90, -1770], [150, -1760], [450, -1840], [800, -1900], [960, -1900], [1010, -1620]] },
...
export const REGIONS = [
  { id: 'arbre', label: [-120, -1300], name: "Sanctuaire de l'Arbre-Brume", biome: 'A', lv: [20, 30], danger: 'jaune', tier: 'T6', circle: [-110, -1180, 110],
    landmarks: ["L'Arbre-Brume", 'Waypoint sanctuaire', 'Source du Bassin des Rois'] },
  { id: 'aldmar', label: [60, -960], name: "Ruines d'Aldmar", biome: 'A', lv: [25, 30], danger: 'rouge', tier: 'T6', plateau: 'aldmar',
    landmarks: ["Plateau à falaises de 50 m", "Crypte d'Aldmar", 'Pierres-runes luisantes', 'Bassin des Rois'] },
  { id: 'couronne', label: [-1650, -2440], name: 'Couronne de Givre', biome: 'S', lv: [25, 30], danger: 'rouge', tier: 'T6', circle: [-1650, -2250, 260],
    landmarks: ['Pic de Givrecime (≈ 395 m)', 'Géant de givre (boss)'] },
  ...
  { id: 'mer_dunes', name: 'Mer de Dunes', biome: 'D', lv: [22, 28], danger: 'rouge', tier: 'T6', circle: [-1800, 1030, 300],
    landmarks: ['Grandes dunes de 25 m', 'Ver des sables (boss)', 'Tombeau des Sables'] },
  { id: 'epave', label: [1780, 1560], name: "Île de l'Épave", biome: 'T', lv: [22, 28], danger: 'rouge', tier: 'T6', circle: [1930, 1400, 190],
    landmarks: ['Épave géante', 'Grotte des Marées'] },
